...
import org.apache.spark.sql.{sources, SparkQueryTestsBase}
...
class AuronJsonSuite extends JsonSuite with SparkQueryTestsBase {
...
class AuronJsonV1Suite extends AuronJsonSuite with SparkQueryTestsBase {
  override def sparkConf: SparkConf =
    super.sparkConf
      .set(SQLConf.USE_V1_SOURCE_LIST, "json")
}

class AuronJsonV2Suite extends AuronJsonSuite with SparkQueryTestsBase {
  override def sparkConf: SparkConf =
    super.sparkConf
...
class AuronJsonLegacyTimeParserSuite extends AuronJsonSuite with SparkQueryTestsBase {
  override def sparkConf: SparkConf =
    super.sparkConf
