...
class AuronSubquerySuite extends SubquerySuite with SparkQueryTestsBase {
  ...
  testAuron("SPARK-26893 Allow pushdown of partition pruning subquery filters to file source") {
    withTable("a", "b") {
