...
class AuronCastSuiteWithAnsiModeOn extends AnsiCastSuiteBase with SparkQueryTestsBase {
...
class AuronAnsiCastSuiteWithAnsiModeOn extends AnsiCastSuiteBase with SparkQueryTestsBase {
...
class AuronAnsiCastSuiteWithAnsiModeOff extends AnsiCastSuiteBase with SparkQueryTestsBase {
...
class AuronTryCastSuite extends TryCastSuite with SparkQueryTestsBase {
