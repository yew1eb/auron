...
class AuronStatisticsCollectionSuite extends StatisticsCollectionSuite with SparkQueryTestsBase {

  import testImplicits._

  testAuron("store and retrieve column stats in different time zones") {
