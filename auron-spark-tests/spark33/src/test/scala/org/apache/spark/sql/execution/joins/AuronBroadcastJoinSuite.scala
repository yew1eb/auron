...
import org.apache.spark.sql.{SparkQueryTestsBase, SparkSession}
 ...
 */
class AuronBroadcastJoinSuite extends BroadcastJoinSuite with SparkQueryTestsBase {
  ...
  override def beforeAll(): Unit = {
    ...
    val sparkBuilder = SparkSession
      ...
      .config("spark.plugins", "org.apache.Auron.AuronPlugin")
