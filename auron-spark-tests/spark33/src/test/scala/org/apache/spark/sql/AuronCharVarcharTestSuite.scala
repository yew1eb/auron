...
class AuronFileSourceCharVarcharTestSuite
  ...
  testAuron("length check for input string values: nested in struct of array") {
    testTableWrite {
      typeName =>
...
class AuronDSV2CharVarcharTestSuite extends DSV2CharVarcharTestSuite with SparkQueryTestsBase {
