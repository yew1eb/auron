...
package org.apache.spark.sql.execution
 ...
 import org.apache.spark.sql.{AuronQueryTestUtil, Row, SparkQueryTestsBase, catalyst}
...
class AuronSortSuite extends SortSuite with SparkQueryTestsBase with AdaptiveSparkPlanHelper {
