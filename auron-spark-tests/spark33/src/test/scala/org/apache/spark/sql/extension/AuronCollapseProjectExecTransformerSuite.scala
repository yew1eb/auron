...
class AuronCollapseProjectExecTransformerSuite extends SparkQueryTestsBase {

  import testImplicits._

  testAuron("Support ProjectExecTransformer collapse") {
    val query =
      """
        |SELECT
        |  o_orderpriority
    ...
    withTable("orders", "lineitem") {
      ...
      Seq(true, false).foreach {
        collapsed =>
          withSQLConf(
          //  AuronConfig.ENABLE_COLUMNAR_PROJECT_COLLAPSE.key -> collapsed.toString,
