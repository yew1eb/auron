...
class AuronSQLCollectLimitExecSuite extends SparkQueryTestsBase {
  ...
  private def assertAuronOperatorMatch[T: reflect.ClassTag](
      df: DataFrame,
  ...
  test("ColumnarCollectLimitExec - basic limit test") {
    ...
    assertAuronOperatorMatch[NativeCollectLimitExec](df, checkMatch = true)
  }
  ...
  test("ColumnarCollectLimitExec - limit after union") {
    ...
    assertAuronOperatorMatch[NativeCollectLimitExec](unionDf, checkMatch = true)
  }
}
