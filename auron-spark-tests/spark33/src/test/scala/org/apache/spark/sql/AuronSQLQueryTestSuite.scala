...
import org.apache.auron.utils.AuronSparkTestSettings
...
class AuronSQLQueryTestSuite
  ...
  override protected def sparkConf: SparkConf = {
    val conf = super.sparkConf
      ...
      //.set(AuronConfig.SMALL_FILE_THRESHOLD.key, "0")
  ...
  private val supportedList: Set[String] =
    AuronSparkTestSettings.getSQLQueryTestSettings.getSupportedSQLQueryTests ++
      AuronSparkTestSettings.getSQLQueryTestSettings.getOverwriteSQLQueryTests
