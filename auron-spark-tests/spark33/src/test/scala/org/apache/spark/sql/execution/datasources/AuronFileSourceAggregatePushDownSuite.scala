...
class AuronParquetV1AggregatePushDownSuite
  extends ParquetV1AggregatePushDownSuite
  with SparkQueryTestsBase {}

class AuronParquetV2AggregatePushDownSuite
  extends ParquetV2AggregatePushDownSuite
  with SparkQueryTestsBase {}

class AuronOrcV1AggregatePushDownSuite
  extends OrcV1AggregatePushDownSuite
  with SparkQueryTestsBase {}

class AuronOrcV2AggregatePushDownSuite
