...
class AuronExec3_4PlusSuite extends AuronQueryTest with BaseAuronSQLSuite {
  ...
  // FIXME  "subquery limit: limit with offset should return correct results"
//  == Results ==
//  !== Correct Answer - 2 ==                                                                                          == Spark Answer - 4 ==
//    struct<t1a:string,t1b:smallint,t1c:int,t1d:bigint,t1e:float,t1f:double,t1g:decimal(4,0),t1h:timestamp,t1i:date>   struct<t1a:string,t1b:smallint,t1c:int,t1d:bigint,t1e:float,t1f:double,t1g:decimal(4,0),t1h:timestamp,t1i:date>
//    ![val1d,null,16,19,17.0,25.0,2600,2014-07-04 01:02:00.001,null]                                                    [val1a,16,12,10,15.0,20.0,2000,2014-07-04 01:01:00.0,2014-07-04]
//  ![val1d,null,16,22,17.0,25.0,2600,2014-06-04 01:01:00.0,null]                                                      [val1c,8,16,19,17.0,25.0,2600,2014-05-04 01:02:00.001,2014-05-05]
//  !                                                                                                                  [val1d,null,16,19,17.0,25.0,2600,2014-07-04 01:02:00.001,null]
//  !                                                                                                                  [val1d,null,16,22,17.0,25.0,2600,2014-06-04 01:01:00.0,null]
  ...
  // struct<both_null:boolean,null_bf:boolean,null_value:boolean>   struct<both_null:boolean,null_bf:boolean,null_value:boolean>
  ...
  // FIXME test NULL inputs for BloomFilterMightContain
