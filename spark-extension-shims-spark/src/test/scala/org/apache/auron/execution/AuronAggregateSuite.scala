...
//        CometConf.COMET_SHUFFLE_MODE.key -> "jvm"
  ...
  // FIXME
  // TODO "AVG decimal supports emit.first"
  //  == Results ==
  ...
  // FIXME
  // TODO "fix: Decimal Average should not enable native final aggregation"
  ...
  // FIXME
  // TODO "SUM, MIN, MAX, AVG for NaN, -0.0 and 0.0"
  //  == Results ==
...
// FIXME
// TODO "SUM/MIN/MAX/AVG on decimal"
