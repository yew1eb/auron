...
import org.apache.auron.expression.CoverageResultStatus.{CoverageResultStatus, Passed}
 ...
 */
//@Ignore
class CometExpressionCoverageSuite extends AuronQueryTest with BaseAuronSQLSuite {
