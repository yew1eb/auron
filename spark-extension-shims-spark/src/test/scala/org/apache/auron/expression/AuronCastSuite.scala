...
import org.apache.auron.testing.DataGenerator

class AuronCastSuite extends AuronQueryTest with BaseAuronSQLSuite {
  import testImplicits._

  // FIXME
  // TODO all tests at AuronCastSuite
  ...
  lazy val usingParquetExecWithIncompatTypes: Boolean = false
...
//    val hasIncompatibleType = (dt: DataType) => true
////      if (
////        // CometConf.COMET_NATIVE_SCAN_IMPL.get() == "auto"
////      ) {
////        true
////      } else {
  ...
  private def castFallbackTest(
    ...
    withTempPath { dir =>
      ...
      withSQLConf((SQLConf.ANSI_ENABLED.key, "false")) {
        ...
        df.collect()
        val str = df.queryExecution.executedPlan.toString
