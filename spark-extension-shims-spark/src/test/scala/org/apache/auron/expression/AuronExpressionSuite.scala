...
import org.apache.spark.sql.{AuronQueryTest, DataFrame, Row, SaveMode}
...
import org.apache.auron.testing.{DataGenerator, DataGenOptions, FuzzDataGenerator}
...
class AuronExpressionSuite extends AuronQueryTest with BaseAuronSQLSuite {
  ...
  // FIXME
  // TODO "sort array of floating point with negative zero"
  test("sort floating point with negative zero") {
    ...
    // ![NaN,0.0]                                 [NaN,-0.0]
    //![NaN,-0.0]                                [NaN,0.0]
//    ![-0.0,0.47287211339526714]                [0.0,-1.7976931348623157E308]
//    ![-0.0,0.4795202682358154]                 [0.0,-0.0]
//    ![-0.0,0.48487633010386033]                [0.0,-0.0]
//    ![-0.0,0.4861792099938226]                 [0.0,0.0]
//    ![-0.0,0.36530365858680347]                [-0.0,1.7976931348623157E308]
//    ![0.0,0.42730397144497423]                 [-0.0,Infinity]
//    ![0.0,0.444843381646181]                   [-0.0,Infinity]
//    ![0.0,0.4467770903884346]                  [-0.0,Infinity]
//    ![-0.0,0.45804085871990874]                [-0.0,Infinity]
//    ![0.0,0.4586098122533998]                  [-0.0,NaN]
//    ![0.0,0.45975259057607587]                 [-0.0,NaN]
//    ![-0.0,0.46615840247377116]                [0.0,null]
//    ![-0.0,0.4670093506982935]                 [0.0,null]
//    ![null,0.0]                                [null,-0.0]
//    ![null,0.0]                                [null,-0.0]
//    ![null,-0.0]                               [null,0.0]
    withSQLConf(
...
//    ![ArrayBuffer(3.4028235E38, -0.0),ArrayBuffer(0.0, -Infinity, 0.281259937930993, Infinity)]      [ArrayBuffer(3.4028235E38, -0.0),ArrayBuffer(-0.0, 0.11771449971473347, 0.6079248803682205)]
//    ![ArrayBuffer(3.4028235E38, -0.0),ArrayBuffer(-0.0, 0.11771449971473347, 0.6079248803682205)]     [ArrayBuffer(3.4028235E38, -0.0),ArrayBuffer(0.0, -Infinity, 0.281259937930993, Infinity)]
//    ![ArrayBuffer(0.0),ArrayBuffer()]                                                     [ArrayBuffer(-0.0),ArrayBuffer()]
//    ![ArrayBuffer(-0.0),ArrayBuffer()]                                                    [ArrayBuffer(-0.0),ArrayBuffer(-Infinity, 0.58526516105174)]
//    ![ArrayBuffer(0.0),ArrayBuffer()]                                                     [ArrayBuffer(-0.0),ArrayBuffer(-1.7976931348623157E308, -1.7976931348623157E308)]
//    ![ArrayBuffer(0.0),ArrayBuffer()]                                                     [ArrayBuffer(-0.0),ArrayBuffer(0.15587462557587528, Infinity)]
//    ![ArrayBuffer(-0.0),ArrayBuffer(-Infinity, 0.58526516105174)]                         [ArrayBuffer(-0.0),ArrayBuffer(0.22651970750198314, 0.9865312326848414, 0.6568729954984174, 0.14111386050001018)]
//    ![ArrayBuffer(-0.0),ArrayBuffer(-1.7976931348623157E308, -1.7976931348623157E308)]    [ArrayBuffer(-0.0),ArrayBuffer(1.7976931348623157E308, 0.7735367774957302)]
//    ![ArrayBuffer(0.0),ArrayBuffer(-0.0, 0.4370134079887301, 0.628452104293808)]          [ArrayBuffer(-0.0, null),ArrayBuffer(-1.7976931348623157E308, 0.13807404098531895)]
//    ![ArrayBuffer(0.0),ArrayBuffer(-0.0, 0.8957985312531923)]                             [ArrayBuffer(-0.0, null, 0.0, 0.4690225),ArrayBuffer(0.2424052967931548, 0.465073105876336, 0.18692825979035355)]
//    ![ArrayBuffer(0.0),ArrayBuffer(0.020861828763866552)]                                 [ArrayBuffer(-0.0, null, 0.3877961, 0.01524657),ArrayBuffer(0.13779420816910304)]
  ...
  // FIXME
  // TODO "sort struct containing floating point with negative zero"
...
//    ![[0.0],[0.7345154157832644]]                                           [[0.0],[0.31241124404467946]]
//    ![[0.0],[0.7348688792213431]]                                           [[0.0],[0.3175850413521498]]
//    ![[-0.0],[0.7389710400687751]]                                          [[0.0],[0.34503534958680404]]
//    ![[0.0],[0.7480661660786175]]                                           [[0.0],[0.3593410569398169]]
//    ![[-0.0],[0.8411940738370172]]                                          [[0.0],[0.3644342337807518]]
//    ![[0.0],[0.8552483736103085]]                                           [[0.0],[0.42730397144497423]]
//    ![[-0.0],[0.8657413377243813]]                                          [[0.0],[0.444843381646181]]
//    ![[-0.0],[0.8806416818375433]]                                          [[0.0],[0.4467770903884346]]
//    ![[-0.0],[0.885146984007593]]                                           [[0.0],[0.4586098122533998]]
//    ![[-0.0],[0.8881354552479427]]                                          [[0.0],[0.45975259057607587]]
//    ![[-0.0],[0.8971765520227165]]                                          [[0.0],[0.5384667395980087]]
//    ![[0.0],[0.934190982794041]]                                            [[0.0],[0.6194738368344533]]
//    ![[0.0],[0.9457179648329408]]                                           [[0.0],[0.6625944410832867]]
//    ![[-0.0],[0.9775759615058621]]                                          [[0.0],[0.6645183487734194]]
//    ![[-0.0],[1.7976931348623157E308]]                                      [[0.0],[0.6967365737954588]]
//    ![[-0.0],[1.7976931348623157E308]]                                      [[0.0],[0.7030260304288376]]
//    ![[-0.0],[1.7976931348623157E308]]                                      [[0.0],[0.7085172615720916]]
//    ![[-0.0],[Infinity]]                                                    [[0.0],[0.7345154157832644]]
//    ![[-0.0],[Infinity]]                                                    [[0.0],[0.7348688792213431]]
//    ![[-0.0],[Infinity]]                                                    [[0.0],[0.7480661660786175]]
//    ![[0.0],[Infinity]]                                                     [[0.0],[0.8552483736103085]]
//    ![[-0.0],[Infinity]]                                                    [[0.0],[0.934190982794041]]
//    ![[-0.0],[NaN]]                                                         [[0.0],[0.9457179648329408]]
//    ![[0.0],[NaN]]                                                          [[0.0],[Infinity]]
//    ![[-0.0],[NaN]]                                                         [[0.0],[NaN]]
    withSQLConf(
      //     CometConf.getExprAllowIncompatConfigKey("SortOrder") -> "false",
      //      CometConf.COMET_EXEC_STRICT_FLOATING_POINT.key -> "true"
  ...
  // FIXME
  // TODO "compare true/false to negative zero"
...
//        ![true,hello]                       [true,null]
  ...
  //FIXME
  //TODO
  // java.lang.RuntimeException: poll record batch error: Execution error: native execution panics: Execution error:
  // Execution error: output_with_sender[Filter] error: Execution error: output_with_sender[ParquetScan] error:
  // Execution error: output_with_sender[ParquetScan]: output() returns error:
  // Arrow error: External error: Execution error: schema_adapter_cast_column unsupported type: UInt64 => Decimal128(20, 0)
  ...
  test("uint data type support") {
    Seq(true, false).foreach { dictionaryEnabled =>
      ...
      Seq(false).foreach { allowIncompatible =>
        {
          withSQLConf(
            // CometConf.COMET_SCAN_ALLOW_INCOMPATIBLE.key -> allowIncompatible.toString
          ) {
            withTempDir { dir =>
  ...
  //FIXME
  //TODO  25/11/30 18:02:24 WARN AuronConverters: Falling back exec: FileSourceScanExec: Data type conversion not implemented TimestampNTZType
  //TODO  25/11/30 18:02:24 WARN AuronConverters: Falling back exec: ProjectExec: Data type conversion not implemented TimestampNTZType
    ...
    Seq(true, false).foreach { dictionaryEnabled =>
      withTempDir { dir =>
        ...
        withParquetTable(path.toString, "dateformattbl") {
          withSQLConf(
            // CometConf.getExprAllowIncompatConfigKey(classOf[TruncDate]) -> "true"
          ) {
            checkSparkAnswerAndOperator(
              "SELECT " +
                "dateformat, _7, " +
  ...
  //FIXME
  //TODO date_trunc on int96 timestamp column
  ...
  test("withInfo") {
    ...
    withTable(table) {
      ...
      val dfx = checkSparkAnswerAndOperator(query)
  ...
  test("rlike fallback for non scalar pattern") {
    ...
    withTable(table) {
      ...
      withSQLConf(
        ...
        val cometPlan = checkSparkAnswer(query2).queryExecution.executedPlan
        //val explain = new ExtendedExplainInfo().generateExtendedInfo(cometPlan)
        println(cometPlan)
        //assert(cometPlan.toString.contains("Only scalar regexp patterns are supported"))
      }
    }
  }
  ...
  //== Results ==
  //!== Correct Answer - 1 ==                                     == Spark Answer - 1 ==
  // struct<(_1 / _2):double,(_3 / _4):double,(_3 / _5):double>   struct<(_1 / _2):double,(_3 / _4):double,(_3 / _5):double>
  ...
  val doubleValues: Seq[Double] = Seq(
    -1.0,
  ...
  test("various math scalar functions") {
    ...
    withParquetTable(data, "tbl") {
      ...
      for (expr <- Seq(
          ...
          "cot")) {
        val (_, cometPlan) =
          checkSparkAnswerWithTolerance(sql(s"SELECT $expr(_1), $expr(_2) FROM tbl"), 1e-6)
        val cometProjectExecs = collect(cometPlan) { case op: NativeProjectBase =>
          op
        }
      ...
      for (expr <- Seq("atan2", "pow")) {
        val (_, cometPlan) =
          checkSparkAnswerWithTolerance(sql(s"SELECT $expr(_1, _2) FROM tbl"), 1e-6)
        val cometProjectExecs = collect(cometPlan) { case op: NativeProjectBase =>
          op
        }
        assert(cometProjectExecs.length == 1, expr)
  ...
  def testDoubleScalarExpr(expr: String): Unit = {
    ...
    for (withDictionary <- Seq(true, false)) {
      withParquetTable(testValuesRepeated.map(n => (n, n)), "tbl", withDictionary) {
        val (_, cometPlan) =
          checkSparkAnswerWithTolerance(sql(s"SELECT $expr(_1) FROM tbl"), 1e-6)
        val projections = collect(cometPlan) { case p: NativeProjectBase =>
          p
        }
  ...
  test("disable expression using dynamic config") {
    ...
    withParquetTable(Seq(0, 1, 2).map(n => (n, n)), "tbl") {
      ...
      val cometPlan = checkSparkAnswerAndOperator(sql).queryExecution.executedPlan
      assert(0 == countSparkProjectExec(cometPlan))
      withSQLConf(
        //CometConf.getExprEnabledConfigKey("Add") -> "false"
      ) {
  ...
  // FIXME   round
  // Caused by: java.lang.RuntimeException: java.lang.RuntimeException: task panics: Execution error: Execution error: output_with_sender[Project] error:
  // Execution error: output_with_sender[Project]: output() returns error:
  // Internal error: could not cast array of type Int8 to arrow_array::array::primitive_array::PrimitiveArray<arrow_array::types::Float64Type>.
  test("round") {
  ...
  // FIXME hex
  // java.lang.RuntimeException: task panics: Execution error: Execution error: output_with_sender[Project] error: Execution error: output_with_sender[ParquetScan] error:
  // Execution error: output_with_sender[ParquetScan]: output() returns error:
  // Arrow error: External error: Execution error: schema_adapter_cast_column unsupported type: UInt64 => Decimal128(20, 0)
  test("hex") {
    // https://github.com/apache/datafusion-comet/issues/1441
  ...
  // FIXME Falling back expression: scala.NotImplementedError: unsupported expression: (class org.apache.spark.sql.catalyst.expressions.UnaryMinus)
  test("negative") {
    Seq(false, true).foreach { dictionary =>
      withSQLConf("parquet.enable.dictionary" -> dictionary.toString) {
        val table = "test"
  ...
  // FIXME Falling back expression: scala.NotImplementedError: unsupported expression: (class org.apache.spark.sql.catalyst.expressions.Cast) cast(cal_dt#7086 as string)
  ...
  // FIXME scala.NotImplementedError: unsupported expression: (class org.apache.spark.sql.catalyst.expressions.Year) year(cast(col#7100 as date))
  ...
  // FIXME scala.NotImplementedError: unsupported expression: (class org.apache.spark.sql.catalyst.expressions.FromUnixTime)
  test("from_unixtime") {
    Seq(false, true).foreach { dictionary =>
      withSQLConf(
        "parquet.enable.dictionary" -> dictionary.toString
  ...
  // FIXME unsupported expression: (class org.apache.spark.sql.catalyst.expressions.Multiply)
  ...
  // FIXME scala.NotImplementedError: unsupported expression: (class org.apache.spark.sql.catalyst.expressions.Add)
  ...
  // FIXME  unsupported expression: (class org.apache.spark.sql.catalyst.expressions.objects.StaticInvoke)
  ...
  // FIXME unsupported expression: (class org.apache.spark.sql.catalyst.expressions.Sha2) sha2(cast(col#7801 as binary), 128)
  ...
  // FIXME [DIVIDE_BY_ZERO] Division by zero. Use `try_divide` to tolerate divisor being 0 and return NULL instead. If necessary set "spark.sql.ansi.enabled" to "false" to bypass this error
  ...
  // FIXME "hash functions with random input"
  ...
  // FIXME "hash function with decimal input"
  ...
  // FIXME "xxhash64 function with decimal input"
  ...
  // FIXME nary negative integer overflow test
  ...
  test("named_struct with duplicate field names") {
    Seq(true, false).foreach { dictionaryEnabled =>
      withTempDir { dir =>
        ...
        makeParquetFileAllPrimitiveTypes(path, dictionaryEnabled = dictionaryEnabled, 10000)
        withParquetTable(path.toString, "tbl") {
          checkSparkAnswerAndOperator(sql("SELECT named_struct('a', _1, 'a', _2) FROM tbl"))
          //classOf[ProjectExec])
          checkSparkAnswerAndOperator(sql("SELECT named_struct('a', _1, 'a', 2) FROM tbl"))
          // classOf[ProjectExec])
          checkSparkAnswerAndOperator(
            sql("SELECT named_struct('a', named_struct('b', _1, 'b', _2)) FROM tbl"))
          //classOf[ProjectExec])
        }
      }
    }
  }
  // FIXME unsupported expression: (class org.apache.spark.sql.catalyst.expressions.StructsToJson
  test("to_json") {
...
// TODO
  ...
  //    }
  //  }
  def testV1AndV2(testName: String)(f: => Unit): Unit = {
    test(s"$testName - V1") {
  ...
  // FIXME   unsupported expression: (class org.apache.spark.sql.catalyst.expressions.ElementAt) element_at
  // TODO
  test("ListExtract") {
  ...
  // FIXME
  // TODO   java.lang.RuntimeException: task panics: Execution error: Execution error: output_with_sender[Project] error:
  //  Execution error: output_with_sender[Project] error: Execution error: assertion failed: idx < self.len
  ...
  // FIXME ANSI support for subtract
  // TODO
  ...
  // FIXME "ANSI support for multiply"
  // TODO
  ...
  // FIXME ANSI support for divide (division by zero) float division
  // TODO
  ...
  // FIXME spark_ext_function_Spark_Round(#9905@0, -1000) AS #9921]] error: Execution error: attempt to calculate the remainder with a divisor of zero
  ...
  def testOnShuffledRangeWithRandomParameters(testLogic: DataFrame => Unit): Unit = {
  ...
  // FIXME rand expression with random parameters
  ...
  // FIXME randn expression with random parameters
  test("randn expression with random parameters") {
    testOnShuffledRangeWithRandomParameters { df =>
      val seed = Random.nextLong()
      val dfWithRandParameters = df.withColumn("randn", randn(seed))
      checkSparkAnswerWithTolerance(dfWithRandParameters, 1e-6)
      val dfWithOverflowSeed = df.withColumn("randn", randn(Long.MaxValue))
      checkSparkAnswerWithTolerance(dfWithOverflowSeed, 1e-6)
      val dfWithNullSeed = df.selectExpr("_1", "randn(null) as randn")
      checkSparkAnswerWithTolerance(dfWithNullSeed, 1e-6)
    }
  }

  // FIXME  spark_partition_id expression on random dataset
  ...
  // FIXME  monotonically_increasing_id expression on random dataset
  ...
  // FIXME  multiple nondetermenistic expressions with shuffle
  test("multiple nondetermenistic expressions with shuffle") {
    testOnShuffledRangeWithRandomParameters { df =>
      ...
      checkSparkAnswerWithTolerance(complexRandDf, 1e-6)
    }
  }

  // FIXME vectorized reader: missing all struct fields
  ...
  test("test concat function - arrays") {
    withTable("t1") {
      ...
      checkSparkAnswerAndFallbackReason("select concat(c1, c2) AS x FROM t1", "unsupportedReason")
      //CometConcat.unsupportedReason)
      checkSparkAnswerAndFallbackReason("select concat(c1, c1) AS x FROM t1", "unsupportedReason")
      //CometConcat.unsupportedReason)
      checkSparkAnswerAndFallbackReason(
  ...
  val supportedFormatsx: Seq[String] =
    Seq("year", "yyyy", "yy", "quarter", "mon", "month", "mm", "week")

  test("trunc (TruncDate)") {
    val supportedFormats = supportedFormatsx
