...
class AuronFuzzAggregateSuite extends AurontFuzzTestBase {
  ...
  // FIXME FileSourceScanExec: Data type conversion not implemented TimestampNTZType
  // TODO
  // Found non-native operator: HashAggregate
  /*
25/12/02 08:03:33 WARN AuronConverters: Falling back exec:
...
scala.NotImplementedError: Data type conversion not implemented TimestampNTZType
  ...
  // FIXME min/max aggregate float ![-Infinity,NaN]                       [-Infinity,Infinity]
  // TODO
  // == Results ==
